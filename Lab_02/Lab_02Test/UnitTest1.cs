...
public class ProgramTests
{
    ...
    {
        var result = Programl.CheckConfiguration(50, 8, true, false);
    ...
    {
        var result = Programl.CheckConfiguration(0, 8, true, false);
    ...
    {
        var result = Programl.CheckConfiguration(50, 1, true, false);
    ...
    {
        var result = Programl.CheckConfiguration(50, 8, true, true);
    ...
    {
        var result = Programl.CheckConfiguration(150, 4, true, false);
    ...
    {
        var result = Programl.CheckConfiguration(0, 8, true, true);
